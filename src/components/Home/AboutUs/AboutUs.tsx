        ...
        <div className="aboutus__content">
          ...
          <div className="aboutus__options">
            <div className="aboutus__option option">
              ...
              <div className="option__text paragraph">Simply dummy text of the printing and typesetting industry. Lorem Ipsum</div>
            </div>
            <div className="aboutus__option option">
          ...
          <button className='aboutus__button default-button default-button_dark'>Shop now</button>
        </div>
      </div>
    </>
  );
